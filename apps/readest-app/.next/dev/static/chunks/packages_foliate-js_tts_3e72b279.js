...
"[project]/packages/foliate-js/tts.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getFragmentWithMarks = (range, textWalker, nodeFilter, granularity)=>{
    ...
    const entries = [
        ...textWalker(range, segmenter, nodeFilter)
    ];
    const fragmentEntries = [
        ...textWalker(fragment, segmenter, nodeFilter)
    ];
    ...
    const ssml = fragmentToSSML(fragment, nodeFilter, {
        lang,
        alphabet
    });
    return {
...
//# sourceMappingURL=packages_foliate-js_tts_3e72b279.js.map