...
"[project]/packages/foliate-js/opds.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(getPublication, "AnWGpHKRhjN7ik2HfZQ8vrefnko=", false, function() {
    return [
        useNS
    ];
});
...
_s1(getFeed, "05RVdHeN3clkcK1Y3Tl2iELSW9w=", false, function() {
    return [
        useNS
    ];
});
const getSearch = async (link)=>{
    const { replace, getVariables } = await __turbopack_context__.A("[project]/packages/foliate-js/uri-template.js [app-client] (ecmascript, async loader)");
    return {
        metadata: {
            title: link.title
        },
...
//# sourceMappingURL=packages_foliate-js_e9b89197._.js.map