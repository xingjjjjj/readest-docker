...
"[project]/packages/foliate-js/comic-book.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const makeComicBook = async ({ entries, loadBlob, getSize, getComment }, file)=>{
    const cache = new Map();
    const urls = new Map();
...
//# sourceMappingURL=packages_foliate-js_comic-book_fced46d3.js.map