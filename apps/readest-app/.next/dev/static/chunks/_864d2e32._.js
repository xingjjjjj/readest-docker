...
"[project]/apps/readest-app/src/services/apiFileSystem.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const resolvePath = (path, base)=>{
    ...
    const isLocalMode = typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$28$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] !== 'undefined' && ("TURBOPACK compile-time value", "local") === 'local' || ("TURBOPACK compile-time value", "object") !== 'undefined' && window.__STORAGE_MODE__ === 'local';
    ...
    switch(base){
        case 'Data':
            return {
                baseDir: 0,
                basePrefix,
                fp: `${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DATA_SUBDIR"]}/${path}`,
                base
            };
        case 'Settings':
        ...
        case 'Fonts':
            return {
                baseDir: 0,
                basePrefix,
                fp: `${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOCAL_FONTS_SUBDIR"]}/${path}`,
                base
            };
        case 'Images':
            return {
                baseDir: 0,
                basePrefix,
                fp: `${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOCAL_IMAGES_SUBDIR"]}/${path}`,
                base
            };
        case 'None':
            return {
...
const apiFileSystem = {
    ...
    async openFile (path, base, filename) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidURL"])(path)) {
            return await new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$file$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RemoteFile"](path, filename).open();
        }
    ...
    async writeFile (path, base, content) {
        ...
        if (content instanceof File) {
            buffer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$28$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(await content.arrayBuffer());
        } else if (typeof content === 'string') {
            buffer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$28$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(content);
        } else {
            buffer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$28$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(content);
        }
    ...
    async createDir (path, base) {
    // No-op for API-based file system
    },
    async removeDir (path, base) {
    // No-op for API-based file system
    },
...
"[project]/apps/readest-app/src/services/webAppService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/services/constants.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$apiFileSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/services/apiFileSystem.ts [app-client] (ecmascript)");
;
;
;
;
...
const getIsLocalStorageMode = ()=>{
    // First check window.__STORAGE_MODE__ (runtime set by Providers)
    if (("TURBOPACK compile-time value", "object") !== 'undefined' && window.__STORAGE_MODE__ === 'local') {
        return true;
    }
    // Fallback to compile-time environment variable
    return (("TURBOPACK compile-time value", "local") || 'remote') === 'local';
};
const basePrefix = async ()=>'';
const resolvePath = (path, base)=>{
    switch(base){
        ...
        case 'Books':
            return {
                baseDir: 0,
                basePrefix,
                fp: `${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOCAL_BOOKS_SUBDIR"]}/${path}`,
                base
            };
        case 'Fonts':
            return {
...
const indexedDBFileSystem = {
    ...
    async readDir (path, base) {
        ...
        return new Promise((resolve, reject)=>{
            ...
            request.onsuccess = ()=>{
                const files = request.result;
                resolve(files.filter((file)=>file.path.startsWith(fp)).map((file)=>({
                        path: file.path.slice(fp.length + 1),
                        size: file.content instanceof Blob ? file.content.size : typeof file.content === 'string' ? file.content.length : file.content instanceof ArrayBuffer ? file.content.byteLength : 0
                    })));
            };
            request.onerror = ()=>reject(request.error);
        });
        ...
        return new Promise((resolve, reject)=>{
            ...
            request.onsuccess = ()=>{
                ...
                if (result) {
                    ...
                    const size = content instanceof Blob ? content.size : typeof content === 'string' ? content.length : content instanceof ArrayBuffer ? content.byteLength : 0;
                    resolve({
                        isFile: true,
                        isDirectory: false,
                        size,
...
class WebAppService extends __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$appService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseAppService"] {
    // Use getter to check storage mode dynamically at runtime
    get fs() {
        return getIsLocalStorageMode() ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$apiFileSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFileSystem"] : "TURBOPACK unreachable";
    }
    isMobile = [
        'android',
        'ios'
    ...
    appPlatform = 'web';
    hasSafeAreaInset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$environment$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isPWA"])();
    async init() {
...
//# sourceMappingURL=_864d2e32._.js.map