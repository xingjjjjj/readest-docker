...
"[project]/apps/readest-app/src/services/apiFileSystem.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$file$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
...
const resolvePath = (path, base)=>{
    ...
    const isLocalMode = typeof process !== 'undefined' && ("TURBOPACK compile-time value", "local") === 'local' || ("TURBOPACK compile-time value", "undefined") !== 'undefined' && window.__STORAGE_MODE__ === 'local';
    if (("TURBOPACK compile-time value", "undefined") === 'undefined' && typeof process !== 'undefined') {
        console.log('[ResolvePath] Env Check - NEXT_PUBLIC_STORAGE_MODE:', ("TURBOPACK compile-time value", "local"), 'isLocalMode:', isLocalMode, 'base:', base, 'path:', path);
    }
    switch(base){
        case 'Data':
            return {
                baseDir: 0,
                basePrefix,
                fp: `${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DATA_SUBDIR"]}/${path}`,
                base
            };
        case 'Settings':
        ...
        case 'Fonts':
            return {
                baseDir: 0,
                basePrefix,
                fp: `${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["LOCAL_FONTS_SUBDIR"]}/${path}`,
                base
            };
        case 'Images':
            return {
                baseDir: 0,
                basePrefix,
                fp: `${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["LOCAL_IMAGES_SUBDIR"]}/${path}`,
                base
            };
        case 'None':
            return {
...
const apiFileSystem = {
    ...
    async openFile (path, base, filename) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isValidURL"])(path)) {
            return await new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$file$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["RemoteFile"](path, filename).open();
        }
...
"[project]/apps/readest-app/src/services/webAppService.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/services/constants.ts [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$apiFileSystem$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/services/apiFileSystem.ts [ssr] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$file$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__,
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$apiFileSystem$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$file$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$appService$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$apiFileSystem$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
    ...
    switch(base){
        ...
        case 'Books':
            return {
                baseDir: 0,
                basePrefix,
                fp: `${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["LOCAL_BOOKS_SUBDIR"]}/${path}`,
                base
            };
        case 'Fonts':
            return {
...
class WebAppService extends __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$appService$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["BaseAppService"] {
    // Use getter to check storage mode dynamically at runtime
    get fs() {
        return getIsLocalStorageMode() ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$apiFileSystem$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["apiFileSystem"] : "TURBOPACK unreachable";
    }
    isMobile = [
        'android',
        'ios'
    ...
    appPlatform = 'web';
    hasSafeAreaInset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$environment$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isPWA"])();
    async init() {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e6a98ac._.js.map