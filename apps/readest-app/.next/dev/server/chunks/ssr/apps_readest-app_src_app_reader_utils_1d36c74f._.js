module.exports = [
"[project]/apps/readest-app/src/app/reader/utils/iframeEventHandlers.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const handleMousedown = (bookKey, event)=>{
    ...
    }, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["LONG_HOLD_THRESHOLD"]);
    window.postMessage({
...
const handleClick = (bookKey, doubleClickDisabled, event)=>{
    const now = Date.now();
    if (!doubleClickDisabled.current && now - lastClickTime < __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DOUBLE_CLICK_INTERVAL_THRESHOLD_MS"]) {
        lastClickTime = now;
        window.postMessage({
    ...
    const postSingleClick = ()=>{
        ...
        if (footnote) {
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$event$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["eventDispatcher"].dispatch('footnote-popup', {
                bookKey,
                element: footnote,
    ...
    if (!doubleClickDisabled.current) {
        setTimeout(()=>{
            if (Date.now() - lastClickTime >= __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DOUBLE_CLICK_INTERVAL_THRESHOLD_MS"]) {
                postSingleClick();
            }
        }, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DOUBLE_CLICK_INTERVAL_THRESHOLD_MS"]);
    } else {
        postSingleClick();
    }
};
...
"[project]/apps/readest-app/src/app/reader/utils/annotatorUtil.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getHighlightColorHex = (settings, color)=>{
    ...
    return customColors?.[color] ?? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["HIGHLIGHT_COLOR_HEX"][color];
};
}),
];

//# sourceMappingURL=apps_readest-app_src_app_reader_utils_1d36c74f._.js.map