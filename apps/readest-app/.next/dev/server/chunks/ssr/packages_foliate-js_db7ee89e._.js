module.exports = [
"[project]/packages/foliate-js/progress.js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/foliate-js/text-walker.js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/foliate-js/view.js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$progress$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/foliate-js/progress.js [ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$text$2d$walker$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/foliate-js/text-walker.js [ssr] (ecmascript)");
;
;
;
;
...
const makeZipLoader = async (file)=>{
    const { configure, ZipReader, BlobReader, TextWriter, BlobWriter } = await __turbopack_context__.A("[project]/packages/foliate-js/vendor/zip.js [ssr] (ecmascript, async loader)");
    configure({
        useWebWorkers: false
    });
...
const makeBook = async (file)=>{
    ...
    if (file.isDirectory) {
        ...
        const { isMOBI, MOBI } = await __turbopack_context__.A("[project]/packages/foliate-js/mobi.js [ssr] (ecmascript, async loader)");
...
class View extends HTMLElement {
    ...
    async open(book) {
        ...
        if (book.splitTOCHref && book.getTOCFragment) {
            ...
            this.#sectionProgress = new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$progress$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["SectionProgress"](book.sections, 1500, 1600);
            const splitHref = book.splitTOCHref.bind(book);
            const getFragment = book.getTOCFragment.bind(book);
            this.#tocProgress = new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$progress$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["TOCProgress"]();
            ...
            this.#pageProgress = new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$progress$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["TOCProgress"]();
        ...
        if (this.isFixedLayout) {
            await __turbopack_context__.A("[project]/packages/foliate-js/fixed-layout.js [ssr] (ecmascript, async loader)");
            this.renderer = document.createElement('foliate-fxl');
        } else {
            await __turbopack_context__.A("[project]/packages/foliate-js/paginator.js [ssr] (ecmascript, async loader)");
    ...
    async addAnnotation(annotation, remove) {
        ...
        if (value.startsWith(SEARCH_PREFIX)) {
            ...
            if (obj) {
                ...
                overlayer.add(value, range, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$overlayer$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["Overlayer"].outline);
            }
            return;
    ...
    #createOverlayer({ doc, index }) {
        const overlayer = new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$overlayer$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["Overlayer"](doc);
        doc.addEventListener('click', (e)=>{
    ...
    getCFI(index, range) {
        const baseCFI = this.book.sections[index].cfi ?? __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$epubcfi$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["fake"].fromIndex(index);
        if (!range) return baseCFI;
        return __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$epubcfi$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["joinIndir"](baseCFI, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$epubcfi$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["fromRange"](range));
    }
    resolveCFI(cfi) {
        if (this.book.resolveCFI) return this.book.resolveCFI(cfi);
        else {
            const parts = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$epubcfi$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["parse"](cfi);
            const index = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$epubcfi$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["fake"].toIndex((parts.parent ?? parts).shift());
            const anchor = (doc)=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$epubcfi$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["toRange"](doc, parts);
            return {
                index,
                anchor
            };
    ...
    resolveNavigation(target) {
        try {
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$epubcfi$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["isCFI"].test(target)) return this.resolveCFI(target);
    ...
    async *search(opts) {
        this.clearSearch();
        const { searchMatcher } = await __turbopack_context__.A("[project]/packages/foliate-js/search.js [ssr] (ecmascript, async loader)");
        const { sections } = this.book;
        const { query, index, results } = opts;
        const matcher = searchMatcher(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$text$2d$walker$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["textWalker"], {
    ...
    async initTTS(granularity = 'word', nodeFilter, highlighter) {
        ...
        const { TTS } = await __turbopack_context__.A("[project]/packages/foliate-js/tts.js [ssr] (ecmascript, async loader)");
        this.tts = new TTS(doc, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$foliate$2d$js$2f$text$2d$walker$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["textWalker"], nodeFilter, highlighter || ((range)=>this.renderer.scrollToAnchor(range, true)), granularity);
    }
    startMediaOverlay() {
...
//# sourceMappingURL=packages_foliate-js_db7ee89e._.js.map