...
"[project]/apps/readest-app/src/utils/debounce.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/readest-app/src/libs/storage.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const API_ENDPOINTS = {
    upload: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$environment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAPIBaseUrl"])() + '/storage/upload',
    download: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$environment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAPIBaseUrl"])() + '/storage/download',
    delete: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$environment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAPIBaseUrl"])() + '/storage/delete',
    stats: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$environment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAPIBaseUrl"])() + '/storage/stats',
    list: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$environment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAPIBaseUrl"])() + '/storage/list',
    purge: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$environment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAPIBaseUrl"])() + '/storage/purge',
    scan: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$environment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAPIBaseUrl"])() + '/storage/scan',
    import: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$environment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAPIBaseUrl"])() + '/storage/import'
};
...
const uploadFile = async (file, fileFullPath, onProgress, bookHash, temp = false, cloudFilePath)=>{
    try {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$environment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isWebAppPlatform"])()) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$transfer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["webUpload"])(file, uploadUrl, onProgress);
        } else {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$transfer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tauriUpload"])(uploadUrl, fileFullPath, 'PUT', onProgress);
        }
...
const downloadFile = async ({ appService, dst, cfp, url, headers, singleThreaded, skipSslVerification, onProgress })=>{
    try {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$environment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isWebAppPlatform"])()) {
            const { headers: responseHeaders, blob } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$transfer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["webDownload"])(downloadUrl, onProgress, headers);
            await appService.writeFile(dst, 'None', await blob.arrayBuffer());
            return responseHeaders;
        } else {
            return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$transfer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tauriDownload"])(downloadUrl, dst, onProgress, headers, undefined, singleThreaded, skipSslVerification);
        }
    } catch (error) {
...
"[project]/apps/readest-app/src/store/trafficLightStore.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useTrafficLightStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$6_$40$types$2b$react$40$18$2e$3$2e$12_react$40$19$2e$2$2e$0$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>{
    return {
        ...
        setTrafficLightVisibility: async (visible, position)=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tauri$2d$apps$2b$api$40$2$2e$9$2e$1$2f$node_modules$2f40$tauri$2d$apps$2f$api$2f$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["invoke"])('set_traffic_lights', {
                visible: visible,
...
//# sourceMappingURL=apps_readest-app_src_1346e583._.js.map