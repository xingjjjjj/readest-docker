module.exports = [
"[externals]/@tauri-apps/plugin-fs [external] (@tauri-apps/plugin-fs, esm_import)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

const mod = await __turbopack_context__.y("@tauri-apps/plugin-fs");

__turbopack_context__.n(mod);
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, true);}),
"[externals]/@tauri-apps/plugin-dialog [external] (@tauri-apps/plugin-dialog, esm_import)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

const mod = await __turbopack_context__.y("@tauri-apps/plugin-dialog");

__turbopack_context__.n(mod);
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, true);}),
"[externals]/@tauri-apps/plugin-os [external] (@tauri-apps/plugin-os, esm_import)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

const mod = await __turbopack_context__.y("@tauri-apps/plugin-os");

__turbopack_context__.n(mod);
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, true);}),
"[externals]/@choochmeque/tauri-plugin-sharekit-api [external] (@choochmeque/tauri-plugin-sharekit-api, esm_import)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

const mod = await __turbopack_context__.y("@choochmeque/tauri-plugin-sharekit-api");

__turbopack_context__.n(mod);
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, true);}),
"[project]/apps/readest-app/src/utils/file.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__ = __turbopack_context__.i("[externals]/@tauri-apps/plugin-fs [external] (@tauri-apps/plugin-fs, esm_import)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__
]);
[__TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
...
class NativeFile extends File {
    ...
    async open() {
        this.#handle = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["open"])(this.#fp, this.#baseDir ? {
    ...
    async readData(start, end) {
        ...
        if (size > NativeFile.MAX_CACHE_CHUNK_SIZE) {
            const handle = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["open"])(this.#fp, this.#baseDir ? {
                baseDir: this.#baseDir
            } : undefined);
            try {
                await handle.seek(start, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["SeekMode"].Start);
    ...
    async #readAndCacheChunkSafe(start, size) {
        ...
        try {
            ...
            await handle.seek(chunkStart, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["SeekMode"].Start);
    ...
    stream() {
        ...
        return new ReadableStream({
            pull: async (controller)=>{
                ...
                await this.#handle.seek(offset, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["SeekMode"].Start);
...
class RemoteFile extends File {
    ...
    async open() {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getOSPlatform"])() === 'android') {
...
"[project]/apps/readest-app/src/utils/files.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[externals]/franc-min [external] (franc-min, esm_import)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

const mod = await __turbopack_context__.y("franc-min");

__turbopack_context__.n(mod);
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, true);}),
"[externals]/iso-639-2 [external] (iso-639-2, esm_import)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

const mod = await __turbopack_context__.y("iso-639-2");

__turbopack_context__.n(mod);
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, true);}),
"[externals]/iso-639-3 [external] (iso-639-3, esm_import)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

const mod = await __turbopack_context__.y("iso-639-3");
...
"[project]/apps/readest-app/src/utils/indexedDBCache.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/readest-app/src/utils/cachedFetch.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$indexedDBCache$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/utils/indexedDBCache.ts [ssr] (ecmascript)");
;
...
async function cachedFetch(url, options = {}) {
    ...
    try {
        ...
        if (finalOptions.cacheStrategy === 'cache-first' && !finalOptions.bypassCache) {
            const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$indexedDBCache$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["indexedDBCache"].get(cacheKey);
            if (cached) {
        ...
        if (!finalOptions.bypassCache && response.status === 200) {
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$indexedDBCache$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["indexedDBCache"].set(cacheKey, data, mimeType, {
                etag: etag || undefined,
...
async function clearFileCache(url) {
    if (url) {
        const cacheKey = generateCacheKey(url);
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$indexedDBCache$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["indexedDBCache"].delete(cacheKey);
        console.log(`[cachedFetch] Cleared cache for: ${url}`);
    } else {
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$indexedDBCache$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["indexedDBCache"].clear();
        console.log('[cachedFetch] Cleared all file caches');
    }
}
async function clearExpiredFileCache() {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$indexedDBCache$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["indexedDBCache"].clearExpired();
}
async function getFileCacheStats() {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$indexedDBCache$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["indexedDBCache"].getStats();
}
}),
"[externals]/@tauri-apps/plugin-http [external] (@tauri-apps/plugin-http, esm_import)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

const mod = await __turbopack_context__.y("@tauri-apps/plugin-http");
...
"[project]/apps/readest-app/src/utils/txt.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$lang$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
...
class TxtToEpubConverter {
    async convert(options) {
        ...
        const bookTitle = this.extractBookTitle((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getBaseFilename"])(txtFile.name));
        ...
        const language = providedLanguage || (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$lang$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["detectLanguage"])(fileHeader);
        console.log(`Detected language: ${language}`);
        const identifier = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$md5$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["partialMD5"])(txtFile);
        const metadata = {
            bookTitle,
            author,
            language,
    ...
    async createEpub(chapters, metadata) {
        const { BlobWriter, TextReader, ZipWriter } = await __turbopack_context__.A("[externals]/@zip.js/zip.js [external] (@zip.js/zip.js, esm_import, async loader)");
    ...
    `;
        ...
        for(let i = 0; i < chapters.length; i++){
            ...
            const lang = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$lang$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["detectLanguage"])(chapter.text);
...
"[project]/apps/readest-app/src/services/errors.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/readest-app/src/utils/font.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const parseFontInfo = (fontData, filename)=>{
    ...
    try {
        ...
        const userLanguage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getUserLang"])();
...
"[project]/apps/readest-app/src/utils/svg.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/readest-app/src/services/appService.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$libs$2f$document$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/libs/document.ts [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/services/constants.ts [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$cachedFetch$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/utils/cachedFetch.ts [ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$txt$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/utils/txt.ts [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$errors$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/services/errors.ts [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$font$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/utils/font.ts [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$svg$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/utils/svg.ts [ssr] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$txt$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$externals$5d2f$uuid__$5b$external$5d$__$28$uuid$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$http__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$http$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$txt$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
class BaseAppService {
    osPlatform = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getOSPlatform"])();
    appPlatform = 'tauri';
    localBooksDir = '';
    isMobile = false;
    isMacOSApp = false;
   ...
   */ async ensureConfigFilesExist() {
        try {
            ...
            const settingsExists = await this.fs.exists(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["SETTINGS_FILENAME"], 'Settings');
            if (!settingsExists) {
                console.log('[Init] settings.json not found, creating with defaults...');
                const defaultSettings = {
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_SYSTEM_SETTINGS"],
                    ...this.isMobile ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_MOBILE_SYSTEM_SETTINGS"] : {},
                    version: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["SYSTEM_SETTINGS_VERSION"],
                    localBooksDir: await this.fs.getPrefix('Books'),
                    globalReadSettings: {
                        ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_READSETTINGS"],
                        ...this.isMobile ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_MOBILE_READSETTINGS"] : {}
                    },
                    globalViewSettings: this.getDefaultViewSettings()
                };
                await this.safeSaveJSON(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["SETTINGS_FILENAME"], 'Settings', defaultSettings);
                console.log('[Init] ✓ settings.json created successfully');
            }
            // Check and create library.json if needed
            const libraryFilename = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getLibraryFilename"])();
    ...
    getCoverImageUrl = (book)=>{
        ...
        const coverPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getCoverFilename"])(book);
    ...
    getCoverImageBlobUrl = async (book)=>{
        ...
        if (this.appPlatform === 'web') {
            try {
                ...
                return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$cachedFetch$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["cachedFetchAsUrl"])(coverUrl, {
                    cacheStrategy: 'cache-first',
                    cacheTTL: 30 * 24 * 60 * 60 * 1000
                }).catch(()=>{
                    // 如果缓存失败，回退到原始方式
    ...
    async getCachedImageUrl(pathOrUrl) {
        const cachedKey = `img_${(0, __TURBOPACK__imported__module__$5b$externals$5d2f$js$2d$md5__$5b$external$5d$__$28$js$2d$md5$2c$__cjs$29$__["md5"])(pathOrUrl)}`;
    ...
    getDefaultViewSettings() {
        return {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_BOOK_LAYOUT"],
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_BOOK_STYLE"],
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_BOOK_FONT"],
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_BOOK_LANGUAGE"],
            ...this.isMobile ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_MOBILE_VIEW_SETTINGS"] : {},
            ...this.isEink ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_EINK_VIEW_SETTINGS"] : {},
            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isCJKEnv"])() ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_CJK_VIEW_SETTINGS"] : {},
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_VIEW_CONFIG"],
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_TTS_CONFIG"],
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_SCREEN_CONFIG"],
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_ANNOTATOR_CONFIG"],
            ...{
                ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_TRANSLATOR_CONFIG"],
                translateTargetLang: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getTargetLang"])()
            }
        };
    }
    async loadSettings() {
        const defaultSettings = {
            ...
            version: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["SYSTEM_SETTINGS_VERSION"],
            localBooksDir: await this.fs.getPrefix('Books'),
            koreaderSyncDeviceId: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$uuid__$5b$external$5d$__$28$uuid$2c$__esm_import$29$__["v4"])(),
            globalReadSettings: {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_READSETTINGS"],
                ...this.isMobile ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_MOBILE_READSETTINGS"] : {}
            },
        ...
        let settings = await this.safeLoadJSON(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["SETTINGS_FILENAME"], 'Settings', defaultSettings);
        const version = settings.version ?? 0;
        if (this.isAppDataSandbox || version < __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["SYSTEM_SETTINGS_VERSION"]) {
            settings.version = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["SYSTEM_SETTINGS_VERSION"];
        }
        settings = {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_SYSTEM_SETTINGS"],
            ...this.isMobile ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_MOBILE_SYSTEM_SETTINGS"] : {},
        ...
        if (!settings.kosync.deviceId) {
            settings.kosync.deviceId = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$uuid__$5b$external$5d$__$28$uuid$2c$__esm_import$29$__["v4"])();
    ...
    async saveSettings(settings) {
        await this.safeSaveJSON(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["SETTINGS_FILENAME"], 'Settings', settings);
    }
    async importFont(file) {
        ...
        if (typeof file === 'string') {
            ...
            fontPath = fileobj.name || (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getFilename"])(filePath);
            await this.fs.copyFile(filePath, fontPath, 'Fonts');
            fontFile = await this.fs.openFile(fontPath, 'Fonts');
        } else if (file) {
            fontPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getFilename"])(file.name);
        ...
        return {
            path: fontPath,
            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$font$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["parseFontInfo"])(await fontFile.arrayBuffer(), fontPath)
        };
    }
    ...
    async importImage(file) {
        ...
        if (typeof file === 'string') {
            const filePath = file;
            const fileobj = await this.fs.openFile(filePath, 'None');
            imagePath = fileobj.name || (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getFilename"])(filePath);
            await this.fs.copyFile(filePath, imagePath, 'Images');
        } else if (file) {
            imagePath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getFilename"])(file.name);
        ...
        try {
            ...
            try {
                if (typeof file === 'string') {
                    ...
                    filename = fileobj.name || (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getFilename"])(file);
                } else {
                    fileobj = file;
                    filename = file.name;
                }
                ...
                if (/\.txt$/i.test(filename)) {
                    const txt2epub = new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$txt$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["TxtToEpubConverter"]();
                    ({ file: fileobj } = await txt2epub.convert({
                        file: fileobj
                    }));
                }
                console.log(`[importBook] Opening document: ${filename}`);
                ({ book: loadedBook, format } = await new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$libs$2f$document$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DocumentLoader"](fileobj).open());
                if (!loadedBook) {
                    throw new Error('Unsupported or corrupted book file');
                }
                const metadataTitle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["formatTitle"])(loadedBook.metadata.title);
                if (!metadataTitle || !metadataTitle.trim() || metadataTitle === filename) {
                    loadedBook.metadata.title = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getBaseFilename"])(filename);
                }
            ...
            const hash = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$md5$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["partialMD5"])(fileobj);
            ...
            const primaryLanguage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getPrimaryLanguage"])(loadedBook.metadata.language);
            const book = {
                hash,
                format,
                title: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["formatTitle"])(loadedBook.metadata.title),
                sourceTitle: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["formatTitle"])(loadedBook.metadata.title),
                primaryLanguage,
                author: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["formatAuthors"])(loadedBook.metadata.author, primaryLanguage),
            ...
            const isLocalStorageMode = ("TURBOPACK compile-time value", "undefined") !== 'undefined' && window.__STORAGE_MODE__ === 'local' || ("TURBOPACK compile-time value", "local") === 'local';
            const shouldUseLocalFlatStorage = this.appPlatform === 'web' && isLocalStorageMode;
            console.log('[ImportBook] appPlatform:', this.appPlatform, 'STORAGE_MODE (runtime):', ("TURBOPACK compile-time value", "undefined") !== 'undefined' && window.__STORAGE_MODE__, 'STORAGE_MODE (env):', ("TURBOPACK compile-time value", "local"), 'shouldUseLocalFlatStorage:', shouldUseLocalFlatStorage);
            const fileExt = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$libs$2f$document$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["EXTS"][format] || format.toLowerCase?.() || 'book';
            const safeBaseName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["makeSafeFilename"])(book.sourceTitle || book.title);
            ...
            const bookFilename = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getLocalBookFilename"])(book);
            if (saveBook && !transient && (!await this.fs.exists(bookFilename, 'Books') || overwrite)) {
                ...
                } else if (typeof file === 'string' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isContentURI"])(file)) {
                    await this.fs.copyFile(file, bookFilename, 'Books');
                } else if (typeof file === 'string' && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isValidURL"])(file)) {
                    try {
            ...
            if (saveCover && (!await this.fs.exists((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getCoverFilename"])(book), 'Books') || overwrite)) {
                ...
                if (cover?.type === 'image/svg+xml') {
                    try {
                        ...
                        cover = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$svg$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["svg2png"])(cover);
                    } catch  {}
                }
                if (cover) {
                    const coverFilename = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getCoverFilename"])(book);
            ...
            if (!existingBook) {
                await this.saveBookConfig(book, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["INIT_BOOK_CONFIG"]);
                books.splice(0, 0, book);
            }
            // update file links with url or path or content uri
            if (typeof file === 'string') {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isValidURL"])(file)) {
                    book.url = file;
   ...
   */ async reclassifyBook(book, newGroupName, oldGroupName) {
    ...
    async deleteBook(book, deleteAction) {
        ...
        if (deleteAction === 'local' || deleteAction === 'both') {
            const localDeleteFps = deleteAction === 'local' ? [
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getLocalBookFilename"])(book)
            ] : [
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getLocalBookFilename"])(book),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getCoverFilename"])(book)
            ];
    ...
    async exportBook(book) {
        ...
        const filename = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["makeSafeFilename"])(book.title)}.${book.format.toLowerCase()}`;
        const filepath = await this.resolveFilePath((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getLocalBookFilename"])(book), 'Books');
        const fileType = file.type || 'application/octet-stream';
        return await this.saveFile(filename, content, filepath, fileType);
    }
    async isBookAvailable(book) {
        const fp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getLocalBookFilename"])(book);
        ...
        if (book.url) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isValidURL"])(book.url);
        }
        return false;
    }
    ...
    async loadBookContent(book) {
        ...
        if (await this.fs.exists(fp, 'Books')) {
            ...
            const bookDir = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getDir"])(book);
            const files = await this.fs.readDir((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getDir"])(book), 'Books');
            if (files.length > 0) {
                const bookFile = files.find((f)=>f.path.endsWith(`.${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$libs$2f$document$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["EXTS"][book.format]}`));
                if (bookFile) {
                    file = await this.fs.openFile(`${bookDir}/${bookFile.path}`, 'Books');
                } else {
                    throw new Error(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$errors$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["BOOK_FILE_NOT_FOUND_ERROR"]);
                }
            } else {
                throw new Error(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$errors$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["BOOK_FILE_NOT_FOUND_ERROR"]);
            }
    ...
    async loadBookConfig(book, settings) {
        const globalViewSettings = {
            ...settings.globalViewSettings,
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$types$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["FIXED_LAYOUT_FORMATS"].has(book.format) ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_FIXED_LAYOUT_VIEW_SETTINGS"] : {}
        };
        try {
            let str = '{}';
            if (await this.fs.exists((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getConfigFilename"])(book), 'Books')) {
                str = await this.fs.readFile((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getConfigFilename"])(book), 'Books', 'text');
            }
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$serializer$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["deserializeConfig"])(str, globalViewSettings, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_BOOK_SEARCH_CONFIG"]);
        } catch  {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$serializer$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["deserializeConfig"])('{}', globalViewSettings, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_BOOK_SEARCH_CONFIG"]);
        }
    }
    async fetchBookDetails(book) {
        ...
        const { file } = await this.loadBookContent(book);
        const bookDoc = (await new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$libs$2f$document$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DocumentLoader"](file).open()).book;
        const f = file;
        if (f && f.close) {
            await f.close();
        }
    ...
    async saveBookConfig(book, config, settings) {
        ...
        if (settings) {
            ...
            serializedConfig = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$serializer$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["serializeConfig"])(config, globalViewSettings, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DEFAULT_BOOK_SEARCH_CONFIG"]);
        } else {
            serializedConfig = JSON.stringify(config);
        }
        await this.fs.writeFile((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getConfigFilename"])(book), 'Books', serializedConfig);
    }
    ...
    async saveLibraryBooks(books) {
        ...
        await this.safeSaveJSON((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getLibraryFilename"])(), 'Books', libraryBooks);
    }
    /**
   * 校准书籍路径
   ...
   */ async applyReconciliation(books, reconcileResults) {
                ...
                if (bookIndex !== -1) {
                    ...
                    if (book) {
                        ...
                        if (result.suggestedGroupName !== undefined) {
                            ...
                            // 更新 groupId
                            book.groupId = result.suggestedGroupName ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$md5$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["md5Fingerprint"])(result.suggestedGroupName) : '';
                        }
    ...
    imageToArrayBuffer(imageUrl, imageFile) {
        return new Promise((resolve, reject)=>{
            ...
            if (this.appPlatform === 'web' && imageUrl && imageUrl.startsWith('blob:')) {
                ...
                (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$http__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$http$2c$__esm_import$29$__["fetch"])(imageUrl, {
                    method: 'GET'
    ...
    async updateCoverImage(book, imageUrl, imageFile) {
        if (imageUrl === '_blank') {
            await this.fs.removeFile((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getCoverFilename"])(book), 'Books');
        } else if (imageUrl || imageFile) {
            const arrayBuffer = await this.imageToArrayBuffer(imageUrl, imageFile);
            await this.fs.writeFile((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getCoverFilename"])(book), 'Books', arrayBuffer);
        }
    }
   ...
   */ async safeSaveJSON(filename, base, data) {
    ...
    /** Ensure necessary directories exist for a book (both legacy hash-based and new flat local paths). */ async ensureLocalBookDirs(book) {
        ...
        if (!await this.fs.exists((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getDir"])(book), 'Books')) {
            await this.fs.createDir((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getDir"])(book), 'Books');
        }
    }
    async migrate20251124() {
        console.log('Running migration for version 20251124 to rename the backup library file...');
        const oldBackupFilename = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getLibraryBackupFilename"])();
        const newBackupFilename = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$book$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getLibraryFilename"])()}.bak`;
   ...
   */ async migrate20260121() {
        ...
        for (const book of books){
            ...
            const ext = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$libs$2f$document$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["EXTS"][book.format] || book.format?.toLowerCase?.() || 'book';
            const safeBaseName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["makeSafeFilename"])(book.sourceTitle || book.title || book.hash);
...
"[project]/apps/readest-app/src/services/nativeAppService.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$dialog__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$dialog$2c$__esm_import$29$__ = __turbopack_context__.i("[externals]/@tauri-apps/plugin-dialog [external] (@tauri-apps/plugin-dialog, esm_import)");
...
var __TURBOPACK__imported__module__$5b$externals$5d2f40$choochmeque$2f$tauri$2d$plugin$2d$sharekit$2d$api__$5b$external$5d$__$2840$choochmeque$2f$tauri$2d$plugin$2d$sharekit$2d$api$2c$__esm_import$29$__ = __turbopack_context__.i("[externals]/@choochmeque/tauri-plugin-sharekit-api [external] (@choochmeque/tauri-plugin-sharekit-api, esm_import)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/utils/misc.ts [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/utils/path.ts [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$file$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/utils/file.ts [ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$files$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/utils/files.ts [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$appService$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/services/appService.ts [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/readest-app/src/services/constants.ts [ssr] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__,
    ...
    __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$dialog__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$dialog$2c$__esm_import$29$__,
    ...
    __TURBOPACK__imported__module__$5b$externals$5d2f40$choochmeque$2f$tauri$2d$plugin$2d$sharekit$2d$api__$5b$external$5d$__$2840$choochmeque$2f$tauri$2d$plugin$2d$sharekit$2d$api$2c$__esm_import$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$file$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__,
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$appService$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$core__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$core$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$dialog__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$dialog$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$os__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$os$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f40$choochmeque$2f$tauri$2d$plugin$2d$sharekit$2d$api__$5b$external$5d$__$2840$choochmeque$2f$tauri$2d$plugin$2d$sharekit$2d$api$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$file$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$bridge$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$appService$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
const getOSType = ()=>{
    if (OS_TYPE === null) {
        OS_TYPE = (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$os__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$os$2c$__esm_import$29$__["type"])();
    }
    return OS_TYPE;
};
...
const getPathResolver = ({ customRootDir, isPortable, execDir } = {})=>{
    ...
    return (path, base)=>{
        ...
        switch(base){
            case 'Settings':
                return {
                    baseDir: isPortable ? 0 : __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["BaseDirectory"].AppConfig,
                    basePrefix: isPortable && execDir ? async ()=>execDir : __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["appConfigDir"],
                    fp: isPortable && execDir ? `${execDir}${path ? `/${path}` : ''}` : path,
                    base
                };
            case 'Cache':
                return {
                    baseDir: __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["BaseDirectory"].AppCache,
                    basePrefix: __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["appCacheDir"],
                    fp: path,
                    base
                };
            case 'Log':
                return {
                    baseDir: isCustomBaseDir ? 0 : __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["BaseDirectory"].AppLog,
                    basePrefix: customBasePrefix ?? __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["appLogDir"],
                    fp: customBasePrefixSync ? `${customBasePrefixSync()}${path ? `/${path}` : ''}` : path,
                    base
                };
            case 'Data':
                return {
                    baseDir: customBaseDir ?? __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["BaseDirectory"].AppData,
                    basePrefix: customBasePrefix ?? __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["appDataDir"],
                    fp: customBasePrefixSync ? `${customBasePrefixSync()}/${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DATA_SUBDIR"]}${path ? `/${path}` : ''}` : `${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["DATA_SUBDIR"]}${path ? `/${path}` : ''}`,
                    base
                };
            case 'Books':
                return {
                    baseDir: customBaseDir ?? __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["BaseDirectory"].AppData,
                    basePrefix: customBasePrefix || __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["appDataDir"],
                    fp: customBasePrefixSync ? `${customBasePrefixSync()}/${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["LOCAL_BOOKS_SUBDIR"]}${path ? `/${path}` : ''}` : `${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["LOCAL_BOOKS_SUBDIR"]}${path ? `/${path}` : ''}`,
                    base
                };
            case 'Fonts':
                return {
                    baseDir: customBaseDir ?? __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["BaseDirectory"].AppData,
                    basePrefix: customBasePrefix || __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["appDataDir"],
                    fp: customBasePrefixSync ? `${customBasePrefixSync()}/${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["LOCAL_FONTS_SUBDIR"]}${path ? `/${path}` : ''}` : `${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["LOCAL_FONTS_SUBDIR"]}${path ? `/${path}` : ''}`,
                    base
                };
            case 'Images':
                return {
                    baseDir: customBaseDir ?? __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["BaseDirectory"].AppData,
                    basePrefix: customBasePrefix || __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["appDataDir"],
                    fp: customBasePrefixSync ? `${customBasePrefixSync()}/${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["LOCAL_IMAGES_SUBDIR"]}${path ? `/${path}` : ''}` : `${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["LOCAL_IMAGES_SUBDIR"]}${path ? `/${path}` : ''}`,
                    base
                };
            case 'None':
                return {
            ...
            default:
                return {
                    baseDir: __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["BaseDirectory"].Temp,
                    basePrefix: __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["tempDir"],
                    fp: path,
                    base
                };
        }
...
const nativeFileSystem = {
    ...
    async getPrefix (base) {
        ...
        return fp ? baseDir === 0 ? fp : await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["join"])(basePath, fp) : basePath;
    },
    getURL (path) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isValidURL"])(path) ? path : (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$core__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$core$2c$__esm_import$29$__["convertFileSrc"])(path);
    },
    ...
    async openFile (path, base, name) {
        ...
        let fname = name || (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getFilename"])(fp);
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isValidURL"])(path)) {
            return await new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$file$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["RemoteFile"](path, fname).open();
        } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isContentURI"])(path) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isFileURI"])(path) && getOSType() === 'ios') {
            fname = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["basename"])(path);
            if (path.includes('com.android.externalstorage')) {
                ...
                return await new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$file$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["NativeFile"](fp, fname, baseDir ? baseDir : null).open();
            } else {
                ...
                const dst = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["join"])(prefix, decodeURIComponent(fname));
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$bridge$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["copyURIToPath"])({
                    uri: path,
                    dst
                });
                if (!res.success) {
                ...
                return await new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$file$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["NativeFile"](dst, fname, baseDir ? baseDir : null).open();
            }
        } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isFileURI"])(path)) {
            return await new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$file$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["NativeFile"](fp, fname, baseDir ? baseDir : null).open();
        } else {
            if (getOSType() === 'android') {
                ...
                const absolutePath = prefix ? await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["join"])(prefix, path) : path;
                return await new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$file$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["RemoteFile"](this.getURL(absolutePath), fname).open();
            }
        }
    },
    async copyFile (srcPath, dstPath, base) {
        try {
            if (!await this.exists((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getDirPath"])(dstPath), base)) {
                await this.createDir((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getDirPath"])(dstPath), base, true);
            }
        } catch (error) {
            console.log('Failed to create directory for copying file:', error);
        }
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isContentURI"])(srcPath)) {
            const prefix = await this.getPrefix(base);
            if (!prefix) {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$bridge$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["copyURIToPath"])({
                uri: srcPath,
                dst: await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["join"])(prefix, dstPath)
            });
            if (!res.success) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["copyFile"])(srcPath, fp, baseDir ? {
    ...
    async readFile (path, base, mode) {
        const { fp, baseDir } = this.resolvePath(path, base);
        return mode === 'text' ? (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["readTextFile"])(fp, baseDir ? {
            baseDir
        } : undefined) : (await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["readFile"])(fp, baseDir ? {
            baseDir
        } : undefined)).buffer;
    },
    async writeFile (path, base, content) {
        ...
        const { fp, baseDir } = this.resolvePath(path, base);
        if (!await this.exists((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getDirPath"])(path), base)) {
            await this.createDir((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$path$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getDirPath"])(path), base, true);
        }
        if (typeof content === 'string') {
            return (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["writeTextFile"])(fp, content, baseDir ? {
                baseDir
            } : undefined);
            ...
            return await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["writeFile"])(fp, content.stream(), writeOptions);
        } else {
            return await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["writeFile"])(fp, new Uint8Array(content), baseDir ? {
                baseDir
            } : undefined);
        }
    },
    async removeFile (path, base) {
        const { fp, baseDir } = this.resolvePath(path, base);
        await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["remove"])(fp, baseDir ? {
            baseDir
        } : undefined);
    },
    async createDir (path, base, recursive = false) {
        const { fp, baseDir } = this.resolvePath(path, base);
        await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["mkdir"])(fp, {
            baseDir: baseDir ? baseDir : undefined,
            recursive
        });
    },
    async removeDir (path, base, recursive = false) {
        const { fp, baseDir } = this.resolvePath(path, base);
        await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["remove"])(fp, {
            baseDir: baseDir ? baseDir : undefined,
            recursive
        });
    },
    async readDir (path, base) {
        ...
        if (!baseDir || baseDir === 0) {
            try {
                const files = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$core__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$core$2c$__esm_import$29$__["invoke"])('read_dir', {
                    path: fp,
                    recursive: true,
                    extensions: [
                        '*'
        ...
        const entries = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["readDir"])(fp, baseDir ? {
            baseDir
        } : undefined);
        const fileList = [];
        const readDirRecursively = async (parent, relative, entries, fileList)=>{
            for (const entry of entries){
                if (entry.isDirectory) {
                    const dir = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["join"])(parent, entry.name);
                    const relativeDir = relative ? await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["join"])(relative, entry.name) : entry.name;
                    try {
                        const entries = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["readDir"])(dir, baseDir ? {
                            baseDir
                        } : undefined);
                    ...
                    const filePath = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["join"])(parent, entry.name);
                    const relativePath = relative ? await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["join"])(relative, entry.name) : entry.name;
                    const opts = baseDir ? {
                        baseDir
                    } : undefined;
                    const fileSize = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["stat"])(filePath, opts).then((info)=>info.size).catch(()=>0);
                    fileList.push({
                        path: relativePath,
                        size: fileSize
                    });
    ...
    async exists (path, base) {
        const { fp, baseDir } = this.resolvePath(path, base);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["exists"])(fp, baseDir ? {
                baseDir
            } : undefined);
            return res;
        } catch  {
    ...
    async stats (path, base) {
        const { fp, baseDir } = this.resolvePath(path, base);
        return await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["stat"])(fp, baseDir ? {
            baseDir
        } : undefined);
    }
};
const DIST_CHANNEL = process.env['NEXT_PUBLIC_DIST_CHANNEL'] || 'readest';
class NativeAppService extends __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$appService$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["BaseAppService"] {
    fs = nativeFileSystem;
    appPlatform = 'tauri';
    isAppDataSandbox = false;
    isMobile = false;
    ...
    async init() {
        ...
        this.hasUpdater = osType !== 'ios' && !process.env['NEXT_PUBLIC_DISABLE_UPDATER'] && !window.__READEST_UPDATER_DISABLED;
        this.hasOrientationLock = osType === 'ios' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$misc$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getOSPlatform"])() === 'ios' || osType === 'android';
        this.hasScreenBrightness = osType === 'ios' || osType === 'android';
        this.hasIAP = osType === 'ios' || osType === 'android' && DIST_CHANNEL === 'playstore';
        const execDir = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$core__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$core$2c$__esm_import$29$__["invoke"])('get_executable_dir');
        this.execDir = execDir;
        if (process.env['NEXT_PUBLIC_PORTABLE_APP'] || await this.fs.exists(`${execDir}/${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$services$2f$constants$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["SETTINGS_FILENAME"]}`, 'None')) {
    ...
    async selectDirectory() {
        const selected = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$dialog__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$dialog$2c$__esm_import$29$__["open"])({
            directory: true,
            multiple: false,
            recursive: true
        });
    ...
    async saveFile(filename, content, filepath, mimeType) {
        try {
            ...
            if (this.isIOSApp) {
                await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$choochmeque$2f$tauri$2d$plugin$2d$sharekit$2d$api__$5b$external$5d$__$2840$choochmeque$2f$tauri$2d$plugin$2d$sharekit$2d$api$2c$__esm_import$29$__["shareFile"])(filepath, {
                    mimeType: mimeType || 'application/octet-stream'
                });
            } else {
                const filePath = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$dialog__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$dialog$2c$__esm_import$29$__["save"])({
                ...
                if (typeof content === 'string') {
                    await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["writeTextFile"])(filePath, content);
                } else {
                    await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$plugin$2d$fs__$5b$external$5d$__$2840$tauri$2d$apps$2f$plugin$2d$fs$2c$__esm_import$29$__["writeFile"])(filePath, new Uint8Array(content));
                }
            }
            return true;
        } catch (error) {
    ...
    async migrate20251029() {
        ...
        const oldDir = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["join"])(rootPath, 'Images', 'Readest', 'Images');
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$readest$2d$app$2f$src$2f$utils$2f$files$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["copyFiles"])(this, oldDir, newDir);
        const dirToDelete = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$tauri$2d$apps$2f$api$2f$path__$5b$external$5d$__$2840$tauri$2d$apps$2f$api$2f$path$2c$__esm_import$29$__["join"])(rootPath, 'Images', 'Readest');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d09009db._.js.map